(function($){
	$.fn.keyboard = function (opts) {
		...
		var curSelectCnt = [];
		var keyList = {
			"pyFirst":[['k_1', 5,5, 66,67],['k_2', 81,5, 66,67],['k_3', 157,5, 66,67],['k_4', 233,5, 66,67],['k_5', 309,5, 66,67],['k_6', 385,5, 66,67],['k_7', 461,5, 66,67],['k_8', 537,5, 66,67],['k_9', 613,5, 66,67],['k_0', 689,5, 66,67],['k_q', 40,72, 66,67],['k_w', 116,72, 66,67],['k_e', 192,72, 66,67],['k_r', 268,72, 66,67],['k_t', 344,72, 66,67],['k_y', 420,72, 66,67],['k_u', 496,72, 66,67],['k_i', 572,72, 66,67],['k_o', 648,72, 66,67],['k_p', 724,72, 66,67],['k_a', 5,139, 66,67],['k_s', 81,139, 66,67],['k_d', 157,139, 66,67],['k_f', 233,139, 66,67],['k_g', 309,139, 66,67],['k_h', 385,139, 66,67],['k_j', 461,139, 66,67],['k_k', 537,139, 66,67],['k_l', 613,139, 66,67],['k_symbol', 689,139, 66,67, "符号"],['k_z', 40,206, 66,67],['k_x', 116,206, 66,67],['k_c', 192,206, 66,67],['k_v', 268,206, 66,67],['k_b', 344,206, 66,67],['k_n', 420,206, 66,67],['k_m', 496,206, 66,67],['k_,', 572,206, 66,67],['k_.', 648,206, 66,67],['k_tab', 135,273, 71,67],['k_space', 216,273, 316,67, "空格"],['k_en', 542,273, 66,67,"拼"],['k_cancel', 55,273, 71,67,"取消"]],
		...
		var optionFunc = {
		        ...
		        "k_backspace": function(){
		            if (tempwords != "") {
		                ...
		                if (curSelectCnt.length)
		    				$("#T1").get(0).setSelectionRange(curSelectCnt[0],curSelectCnt[1]);
		            } else {
		                DeleteText(ObjectId);
		            }
		            if ($("#T1").val()|| $("#tempwordsshow").html()){
		        ...
		        "k_enter" : function(){
		            ReturnVaule = document.getElementById("T1").value;
		            onDone();
				},
				"k_space": function(){
		            if (tempwords == "") {
				...
				"k_cancel": function(){
			        ...
			        typeof param.returnCallback == "function" && param.returnCallback();
			        closekeyboard();
				}
			};
		function dhKeyBoard() {
		...
		*/
		...
		function openkeyboard() {
			...
			var pyBg2 = new Image();
			pyBg2.src = "images/py_2.png";
			pyBg2.onload = function(){};
			
			var enBg1 = new Image();
			enBg1.src = "images/en_1.png";
			enBg1.onload = function(){};
			
			var enBg2 = new Image();
			enBg2.src = "images/en_2.png";
			enBg2.onload = function(){};
			
			var sym = new Image();
			sym.src = "images/sym.png";
			sym.onload = function(){};
		}
		...
		function keyboardInit(p){
		    ...
		    /*
		    $("input").not('#T1').bind("focus", function () {
		        currentSearchText = $(this).attr("value");
		        d.target.relatedInput = this;
		        $('#T1')[0].value = currentSearchText;
				typeof param.clickCallback == "function" && param.clickCallback();
		        openkeyboard();
		    });*/
		    $("input").not('#T1').on("focus", function () {
//		        currentSearchText = $(this).attr("value");
//		        if($("#T1").length>0)
//		        {
//		        	$("#T1").attr("value",currentSearchText);
//		        	if(currentSearchText&&currentSearchText[0])
//		        	{
//		            	setSelection($("#T1")[0],currentSearchText[0].length);
//		        	}
//		        }
//		        currentSearchText = "";
//		        
...
//		        openkeyboard();
		    ...
		    $("input").not('#T1').on("click", function () {
		        currentSearchText = $(this).attr("value");
		        if(currentSearchText=="邮箱/会员账号/手机号")
		        	currentSearchText="";
...
//		        openkeyboard();
		    ...
		    if($("input").not('#T1')&&$("input").not('#T1').length>0)
		    {
		    	for(var p in $("input").not('#T1'))
		    	{
		    		$("input").not('#T1')[p].disabled = false;
				};
		    }
		    if($("textarea")&&$("textarea").length>0)
		    {
		    	for(var p in $("textarea"))
		    	{
		    		$("textarea")[p].disabled = false;
				};
		    }
		}
		...
		function installKeyBoardEvent(){
			$("#T1").unbind("click").bind("click", function(){
		...
		function uninstallKeyBoardEvent(){
			$("#T1").unbind("click").unbind("focus").unbind("change");
